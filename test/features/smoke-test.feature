  ...
  シナリオ: ログインから入金完了までの流れを確認 (継続割引)
    ...
    ならば  "入金が確認できたものにチェックを付けて、確認ボタンを押してください。" と表示されていること
      かつ  入金確認一覧に以下の内容が表示されていること:
        ...
        | 00-000001 | 動画配信会員 3人目 | ccc@bbb.ccc  | 基礎コース１年目 第１回～第４回  |
    ...
    ならば  お知らせに以下の内容が表示されていること:
      """
      入金が確認できました。 基礎コース１年目 第９回～第１２回 (受講開始 11月15日) ※基礎コース１年目第１回～第４回以外は、受講開始のご連絡はいたしません。 期日になりましたら、各自受講を開始して下さい。
      """
